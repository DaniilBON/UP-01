...
class TypesOfDeviceActivity : AppCompatActivity() {
    private val sharedPrefFile = "kotlinsharedpreference"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_types_of_device)
        ...
        fun back2 (view: View){
            val intent: Intent = Intent(this@TypesOfDeviceActivity, MainActivity::class.java)
