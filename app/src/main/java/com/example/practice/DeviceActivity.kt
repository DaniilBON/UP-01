...
class DeviceActivity : AppCompatActivity() {
    private val sharedPrefFile3 = "kotlinsharedpreference3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPreferences: SharedPreferences =
            this.getSharedPreferences(sharedPrefFile3, Context.MODE_PRIVATE)
        ...
        fun back2 (view: View){
            val intent: Intent = Intent(this@DeviceActivity, MainActivity::class.java)
