...
class AddTypesActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_add_types)
    }
    fun Profile (view: View){
        val intent: Intent = Intent(this@AddTypesActivity, ProfileActivity::class.java)
    ...
    fun AddType(view: View){
        ...
        val intent: Intent = Intent(this@AddTypesActivity, TypesOfDeviceActivity::class.java)
